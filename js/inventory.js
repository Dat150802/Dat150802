...
// Realtime khi collection thay đổi từ tab khác / module khác
...
function setupEvents(){
  ...
  if(searchInput){
    // Dùng helper bindSearch và tái dùng applySearchFilter()
...
function renderTables(data){
  ...
  tableBody.innerHTML = data.map(item => `<tr class="border-b last:border-b-0">
      ...
      <td class="px-3 py-2">${item.type==='import'
        ? '<span class="badge badge-success">Nhập</span>'
        : '<span class="badge badge-danger">Xuất</span>'}</td>
